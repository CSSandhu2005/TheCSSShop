                        ...
                        <div className="relative z-10 mx-auto max-w-4xl text-center">
                            ...
                            <AnimatedGroup
                                ...
                                <div
                                    ...
                                    <div className="bg-background border-border/50 absolute inset-0 mx-auto w-80 -translate-x-3 -translate-y-12 rounded-[2rem] border p-2 mask-[linear-gradient(to_bottom,#000_50%,transparent_90%)] sm:-translate-x-6">
                                    ...
                                    <div className="bg-muted dark:bg-background/50 border-border/50 mx-auto w-80 translate-x-4 rounded-[2rem] border p-2 backdrop-blur-3xl mask-[linear-gradient(to_bottom,#000_50%,transparent_90%)] sm:translate-x-8">
...
const AppComponent = () => {
    return (
        <div className="relative space-y-3 rounded-3xl bg-white/5 p-4">
