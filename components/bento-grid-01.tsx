...
export default function FeaturesSection() {
  return (
    <section className="bg-tranparent px-6 py-24 min-h-screen flex items-center justify-center z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4 auto-rows-[200px]">
          ...
          >
            ...
            <div className="mt-4">
              ...
              <p className="text-gray-400 text-sm -mt-1bg-red-500">Blazing fast performance.</p>
            </div>
          </motion.div>
