    ...
    <section className="flex min-h-screen items-center justify-center px-6">
      <div className="relative flex flex-col items-center gap-12">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            >
              <span className="block overflow-hidden">
                <span
                  className="block font-semibold transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]"
                  style={{
              ...
              <span className="block overflow-hidden">
                ...
                >
                  <span className="text-muted-foreground/60">Let's Create</span>
                </span>
              </span>
            </h2>
        ...
        >
          ...
          <span className="text-xs tracking-widest uppercase text-muted-foreground/60">TheCSSShop@GMail.Com</span>
        </div>
      </div>
    </section>
  )
